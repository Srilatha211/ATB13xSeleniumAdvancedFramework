...
public class TestVWOLogin_03_Improved_Properties_POM extends CommonToAllTest {


    private static final Logger logger = LogManager.getLogger(TestVWOLogin_03_Improved_Properties_POM.class);
